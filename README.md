...
| `refs.bib` | 参考文献 |
| `assets/` | 图片 |
| `fonts/` | 构建用字体（OFL / Arphic 许可，含 IBM Plex、Noto Serif SC、AR PL UKai） |
...
作者原创内容（笔记正文、自绘图表）采用 [CC BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/)（署名-非商业性使用）授权；课程、书籍来源的图片版权归原作者，图注已标注出处。`fonts/` 内字体依各自许可分发（IBM Plex、Noto Serif SC 为 SIL OFL，AR PL UKai 为 Arphic Public License），不随本文档的 CC BY-NC 授权。
